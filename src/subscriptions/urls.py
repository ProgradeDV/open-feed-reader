...
urlpatterns = [
    ...
    path("feeds/<int:source_id>/subscribe/",   views.subscribe_feed,          name="subscribe_feed"),
    path("feeds/<int:source_id>/unsubscribe/", views.unsubscribe_feed,        name="unsubscribe_feed"),
